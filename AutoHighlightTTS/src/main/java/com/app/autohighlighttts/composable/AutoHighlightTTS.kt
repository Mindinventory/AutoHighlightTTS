package com.app.autohighlighttts.composable
 ...
 * @param autoHighlightTTSBuilder: TextHighlightBuilder
 */
@Composable
internal fun AutoHighlightTTS(
    ...
    Text(
        modifier = modifier,
        text = autoHighlightTTSBuilder.annotatedString,
        color = color,
        fontSize = fontSize,
        fontStyle = fontStyle,
 ...
 */
data class AutoHighlightTTSBuilder(
    val text: String,
