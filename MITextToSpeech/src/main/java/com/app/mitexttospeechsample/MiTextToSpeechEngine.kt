...
import com.app.mitexttospeechsample.models.ParagraphModel
import java.util.Locale


class MiTextToSpeechEngine {

    /**
     * Create Singleton Object
     */
    companion object {
        private var instance: MiTextToSpeechEngine? = null
        fun getInstance(): MiTextToSpeechEngine {
            if (instance == null) {
                instance = MiTextToSpeechEngine()
            }
            return instance!!
        }
    }
    ...
    lateinit var miTTS: TextToSpeech
    ...
    /**
     * Initialization of [MiTextToSpeechEngine]
     */
    fun init(app: Context): MiTextToSpeechEngine {
        miTTS = TextToSpeech(app) {
            if (it == TextToSpeech.SUCCESS) {
                miTTS.language = defLanguage
            }
        }
        return this
    }
     ...
     */
    fun setLanguage(local: Locale): MiTextToSpeechEngine {
     ...
     */
    fun pauseTextToSpeech(): MiTextToSpeechEngine {
        if (miTTS.isSpeaking) {
            miTTS.stop()
        }
     ...
     */
    fun setText(text: String): MiTextToSpeechEngine {
        mainText = text
     ...
     */
    fun playTextToSpeech(): MiTextToSpeechEngine {
        if (mainText.isNotBlank()) {
            ...
            miTTS.play(currentSpokenSentenceCopy)
            ...
            miTTS.setOnUtteranceProgressListener(object : UtteranceProgressListener() {
     ...
     */
    private fun updateProgress(currentIndex: Int = currentCount.intValue): MiTextToSpeechEngine {
     ...
     */
    fun sliderToUpdate(currentIndex: Int): MiTextToSpeechEngine {
     ...
     */
    fun forwardText(): MiTextToSpeechEngine {
     ...
     */
    fun backwardText(): MiTextToSpeechEngine {
     ...
     */
    private fun highlightFunction(): MiTextToSpeechEngine {
        highlightTextPair.value =
     ...
     */
    fun setOnCompletionListener(onDoneListener: () -> Unit): MiTextToSpeechEngine {
     ...
     */
    fun setOnErrorListener(onErrorListener: (String) -> Unit): MiTextToSpeechEngine {
     ...
     */
    fun setOnEachSentenceStartListener(onEachSentenceStartListener: () -> Unit): MiTextToSpeechEngine {
     ...
     */
    fun setPitchAndSpeed(pitch: Float = 1f, speed: Float = 1f): MiTextToSpeechEngine {
        miTTS.setPitch(pitch)
        miTTS.setSpeechRate(speed)
        return this
    }
}